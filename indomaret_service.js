...
async function getProxy() {
    try {
        const response = await axios.get('https://api.proxyscrape.com/v2/?request=getproxies&protocol=https&timeout=10000&country=all&ssl=yes&anonymity=all&api_key=nhuyjukilompnbvfrtyuui', { timeout: 5000 });
